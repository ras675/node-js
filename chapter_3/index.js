...
// Define the /quote API endpoint
app.get("/quote", (req, res) => {
  // Get a random quote from the dummy data
  const randomQuote = getRandomQuote();

  // Send the random quote in the response object
  res.json(randomQuote);
});

// Function to get a random quote from the dummy data
...
app.listen(8080, () => {
  console.log("Quotes API is running on http://localhost:8080");
});
